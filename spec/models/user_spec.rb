...
describe User do
	...
	describe "when user does not have email address" do
		before{@user.email = "  "}
		it {should_not be_valid}
	end

	describe "when user  > 50 chars" do 
	...
	describe "when email is not unique" do
		before do 
			...
			user_with_the_same_email.email.upcase!
	...
	describe "return avalue of authenticate method" do 
		before {@user.save}
